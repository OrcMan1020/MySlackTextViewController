...
@property (nonatomic, readonly) SLKNewInputAccessoryView* trueTextInputBar;
...
-(SLKNewInputAccessoryView*)trueTextInputBar
{
    return (SLKNewInputAccessoryView*)self.textInputbar;
...
//{
//    self.trueTextInputBar.inputComposerExpanded = !self.trueTextInputBar.inputComposerExpanded;
